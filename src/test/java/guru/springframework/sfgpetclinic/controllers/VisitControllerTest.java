...
class VisitControllerTest {
    ...
    //Class PetMapService - not interface PetService
     @Spy //@Mock
    ...
    void loadPetWithVisit() {
        ...
        //save pet in Spy-Object to find use real search in given statement
        petService.save(pet);
    ...
    void loadPetWithVisitWithStubbing() {
        ...
        // does not use the real method - returns what we want
